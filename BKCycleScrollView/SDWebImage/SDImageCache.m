...
- (nullable NSString *)defaultCachePathForKey:(nullable NSString *)key {
    ...
    if ([key containsString:@"?imageView2/2/w/750"]) {
        key = [NSString stringWithFormat:@"%@?imageView2/2/w/750",[key componentsSeparatedByString:@"?imageView2/2/w/750"][0]];
    }else if ([key containsString:@"?imageView2/2/w/400"]) {
        key = [NSString stringWithFormat:@"%@?imageView2/2/w/400",[key componentsSeparatedByString:@"?imageView2/2/w/400"][0]];
    }else if ([key containsString:@"?imageView2/2/w/100"]) {
        key = [NSString stringWithFormat:@"%@?imageView2/2/w/100",[key componentsSeparatedByString:@"?imageView2/2/w/100"][0]];
    }else if ([key containsString:@"?sign"]) {
        key = [key componentsSeparatedByString:@"?sign"][0];
    }

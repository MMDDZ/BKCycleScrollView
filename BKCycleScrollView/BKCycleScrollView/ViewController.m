...
//  BKCycleScrollView
//
//  Created by zhaolin on 2018/6/7.
...
-(BKCycleScrollView*)cycleScrollView1
{
    if (!_cycleScrollView1) {
        ...
        _cycleScrollView1.itemInset = UIEdgeInsetsMake(0, 20, 0, 20);
...
-(BKCycleScrollView*)cycleScrollView3
{
    if (!_cycleScrollView3) {
        ...
        _cycleScrollView3.itemInset = UIEdgeInsetsMake(0, 175, 0, 175);
